...
function ClickHandler() {
    ...
    this.addAgent = function (req, res) {
        ...
        req.on('end', function () {
            ...
            newUser.local.id = value.username;
            newUser.local.password = value.password;
            newUser.local.role = 'agent';
            newUser.local.agent.address = value.address;
            newUser.local.agent.phone = value.phone;
            newUser.local.agent.name = value.name;
    ...
    this.addModel = function (req, res) {
        var model = req.url.match(/\/addModel\/(.*)/)[1];
